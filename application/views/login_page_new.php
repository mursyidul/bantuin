...
<head>
  ...
  <link rel="shortcut icon" type="image/x-icon" href="<?php echo base_url('assets/images/iconbiru.png') ?>" />
...
<body>
  <main>
    ...
    <section class="dzsparallaxer auto-init height-is-based-on-content use-loading mode-scroll loaded dzsprx-readyall" data-options="{direction: 'reverse', settings_mode_oneelement_max_offset: '150'}">
      <!-- Parallax Image -->
      <div class="divimage dzsparallaxer--target w-100 u-bg-overlay g-bg-size-cover g-bg-bluegray-opacity-0_3--after" style="height: 140%; background-image: url(assets/images/cover.jpg); filter: blur(8px); -webkit-filter: blur(8px);"></div>
      <!-- End Parallax Image -->
      ...
      <div class="container g-pt-100 g-pb-200">
        <div class="row justify-content-between">
          ...
          <div class="col-md-6 flex-md-first align-self-center g-mb-80">
            <div class="mb-5">
              <h1 class="h3 g-color-white g-font-weight-600 mb-3"><strong>PT. Bina Rekacipta Utama</strong><br>Integrated Oil and Gas Engineering Company</h1>
            ...
            <div class="row">
              <div class="col-md-11 col-lg-9">
                ...
                <div class="media">
                  <img class="d-flex align-self-center rounded-circle g-width-40 g-height-40 mr-3" src="assets/images/profil.jpg" alt="Image Description">
                  <div class="media-body align-self-center">
                    <h4 class="h6 g-color-primary g-font-weight-600 g-mb-0">Emcorpstudio</h4>
