				...
				<div class="col-md-8">
					...
					<form class="m-t" role="form" action="<?php echo base_url("login/action") ?>" method="POST">
						<div class="input-container">
							...
							<input class="input-field" type="text" placeholder="Username" name="username" value="admin@gmail.com" required="">
						</div>
						<div class="input-container">
							<i class="fa fa-key icon toggle-password" toggle="#password"></i>
							<input class="input-field" id="password" type="password" placeholder="Password" name="password" value="admin">
						</div>

						<button type="submit" name="login" class="btn btn-success block full-width m-b">LOGIN</button>
					</form>
					<p class="m-t" style="text-align:center;">
						<small>Developed By <a href="http://www.emcorpstudio.com/" target="_blank">Emcorp Studio</a> | PT. Bina Rekacipta Utama &copy; <?php echo date('Y'); ?></small>
					</p>
				</div>
